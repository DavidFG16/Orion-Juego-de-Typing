...
const checkIfUserLoses = () => {
    // VVerifica si la palabra esta debajo del ViewHeight cuando cae para que el usuario pierda  
...
const reactToShoot = (writtingWordProgressArray, splittedCurrentlyWrittingWord) => {
    ...
    document.querySelector(`#${currentlyWrittingWord}`).children[writtingWordProgressArray.length - 1].style.transition = '0.5s';
    document.querySelector(`#${currentlyWrittingWord}`).children[writtingWordProgressArray.length - 1].style.color = '#fb2bff';
    document.querySelector(`#${currentlyWrittingWord}`).children[writtingWordProgressArray.length - 1].style.fontSize = '55px';
    document.querySelector(`#${currentlyWrittingWord}`).children[writtingWordProgressArray.length - 1].style.opacity = '0';
}
